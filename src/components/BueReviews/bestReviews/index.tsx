    ...
    <section className="best-reviews">
      <div className="best-reviews__header">
        <div className="reviews-colum">
          ...
          <p className="reviews-colum__desc">Напишіть нам в любому зручному для вас месенджері або відправте запит</p>
        </div>
        <div className="social-reviews">
          <a href="#" className="social-reviews__link">
            <img src="/img/social/1.svg" alt="social" className="socials__icon" />
          </a>
          <a href="#" className="social-reviews__link">
            <img src="/img/social/2.svg" alt="social" className="socials__icon" />
          </a>
          <a href="#" className="social-reviews__link">
            <img src="/img/social/3.svg" alt="social" className="socials__icon" />
          </a>
        </div>
